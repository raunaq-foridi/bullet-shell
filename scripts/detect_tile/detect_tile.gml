...
function detect_tile_objectless(_relX,_relY){ //checks for a tile collision, if the object was moved by (relx,relY)
	...
	//platforms DONT count as collisions for this one
	/*if(place_meeting(x+_relX,y + _relY, o_solid_platform)){
		_collision=true;}*/
